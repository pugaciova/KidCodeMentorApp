...
public class BasicsLesson4 extends AppCompatActivity {
    private SharedPreferences sharedPreferences;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_basics_lesson4);
        ...
        completeLessonButton.setOnClickListener(view -> {
            ...
            BasicsInnActivity.updateLessonState(sharedPreferences, "lesson_4", 100, "lesson_5");

            // Сохранение прогресса в Firebase
            saveLessonProgressToFirebase();

            // Вернуться к странице со списком уроков
            Intent intent = new Intent(BasicsLesson4.this, BasicsInnActivity.class);
    ...
    private void saveLessonProgressToFirebase() {
        ...
        database.child("users").child(userId).child("courses").child("course_1")
                .child("lessons_completed").child("lesson_4").setValue(true);
